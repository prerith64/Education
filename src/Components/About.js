...
const About = () => {
 return(
    <>
      <h1>Edutech Organisation</h1>
      <h3>location:320 N. Morgan, Suite 600
 Chicago, IL 60607
United States
Phone: +1 312-840-4100</h3>
      <p>React Community
...
Stack Overflow 
Stack Overflow is a popular forum to ask code-level questions or if you’re stuck with a specific error. Read through the existing questions tagged with reactjs or ask your own!</p>
    </>
 );
};
